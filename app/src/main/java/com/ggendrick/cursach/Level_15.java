...
public class Level_15 extends AppCompatActivity {
    private final static int level = 15;
   private SharedPreferences pref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_to_main = (Button)dialog.findViewById(R.id.button_to_main);
        button_to_main.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_15.this,MainActivity.class);
        ...
        butonback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {   Intent intent = new Intent(Level_15.this,Levels_list.class);
                        startActivity(intent);
                        finish();
                }catch (Exception e){}
            }
        ...
        if(rand_of_two==1){
            leftnum=array.with[random.nextInt(20)];
             rightnum=array.without[random.nextInt(30)];
        }

        else if(rand_of_two==0){
            rightnum=array.with[random.nextInt(20)];
            leftnum=array.without[random.nextInt(30)];
        }
    ...
    public void onBackPressed() {
        try {
            Intent intent = new Intent(Level_15.this,Levels_list.class);
            startActivity(intent);
            finish();
        }catch (Exception e){}
