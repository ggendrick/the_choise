    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_7.this,Levels_list.class);
        ...
        butonback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {   Intent intent = new Intent(Level_7.this,Levels_list.class);
                        startActivity(intent);
                        finish();
                }catch (Exception e){}
            }
        ...
        final Animation a = AnimationUtils.loadAnimation(Level_7.this,R.anim.alpha);
