...
public class Level_12 extends AppCompatActivity {
   ...
   private SharedPreferences pref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_12.this,Levels_list.class);
        ...
        butonback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {   Intent intent = new Intent(Level_12.this,Levels_list.class);
                        startActivity(intent);
                        finish();
                }catch (Exception e){}
            }
        ...
        final Animation a = AnimationUtils.loadAnimation(Level_12.this,R.anim.alpha);
    ...
    if(leftnum%3==0){  while((leftnum==rightnum)||(rightnum%3==0)){
        rightnum=random.nextInt(99)+1;}}
    else{ while((leftnum==rightnum)||(rightnum%3!=0)){
            rightnum=random.nextInt(99)+1;}
    }
        ...
        img_left_left.setOnTouchListener(new View.OnTouchListener() { //слушатель нажатия на  левую картинку
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) { //метод, вызываемый нажатием на картинку
                if(motionEvent.getAction()==motionEvent.ACTION_DOWN){ // когда картинка нажата проверяем правильность нажаития и выводоим картинки правда или ложь
                    ...
                    if(leftnum%3!=0){ //меняем счет в случае правильного ответа
                        if(score<20){
                            score++;
                        }
        ...
        img_right_left.setOnTouchListener(new View.OnTouchListener() { //слушатель нажатия на  левую картинку
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) { //метод, вызываемый нажатием на картинку
                if(motionEvent.getAction()==motionEvent.ACTION_DOWN){ // когда картинка нажата проверяем правильность нажаития и выводоим картинки правда или ложь
                    ...
                    if(rightnum%3!=0){ //меняем счет в случае правильного ответа
                        if(score<20){
                            score++;
                        }
