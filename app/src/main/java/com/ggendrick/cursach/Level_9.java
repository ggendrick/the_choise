...
public class Level_9 extends AppCompatActivity {
    private final static int level = 9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_9.this,Levels_list.class);
        ...
        button_next_level.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_9.this,Level_10.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){}
            }
        ...
        butonback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {   Intent intent = new Intent(Level_9.this,Levels_list.class);
                        startActivity(intent);
                        finish();
                }catch (Exception e){}
            }
        ...
        final Animation a = AnimationUtils.loadAnimation(Level_9.this,R.anim.alpha);
