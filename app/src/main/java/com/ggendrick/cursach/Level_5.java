...
public class Level_5 extends AppCompatActivity {
   ...
   private SharedPreferences pref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_5.this,Levels_list.class);
        ...
        butonback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {   Intent intent = new Intent(Level_5.this,Levels_list.class);
                        startActivity(intent);
                        finish();
                }catch (Exception e){}
            }
        ...
        final Animation a = AnimationUtils.loadAnimation(Level_5.this,R.anim.alpha);
    ...
    if(leftnum%3==0){
        while (rightnum%3==0){ rightnum=random.nextInt(9)+1; }
    }
    else{
        while (rightnum%3!=0){rightnum=random.nextInt(9)+1; }
    }
