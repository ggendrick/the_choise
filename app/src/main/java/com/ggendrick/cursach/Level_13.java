...
public class Level_13 extends AppCompatActivity {
    private final static int level = 13;
   private SharedPreferences pref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_continue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_13.this,Levels_list.class);
        ...
        butonback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {   Intent intent = new Intent(Level_13.this,Levels_list.class);
                        startActivity(intent);
                        finish();
                }catch (Exception e){}
            }
        ...
        final Animation a = AnimationUtils.loadAnimation(Level_13.this,R.anim.alpha);
    ...
    if((leftnum>50)&&(rightnum>50)){
        while(leftnum==rightnum){
            rightnum=random.nextInt(49)+51; }
    }
    else if ((leftnum<50)&&(rightnum<50)){
        while(leftnum==rightnum){
            rightnum=random.nextInt(49)+1; }

    }
    while(leftnum-50==50-rightnum) {
        rightnum=random.nextInt(49)+1;
    }
        while(rightnum-50==50-leftnum) {
            rightnum=random.nextInt(49)+51;
        }
        ...
        img_left_left.setOnTouchListener(new View.OnTouchListener() { //слушатель нажатия на  левую картинку
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) { //метод, вызываемый нажатием на картинку
                if(motionEvent.getAction()==motionEvent.ACTION_DOWN){ // когда картинка нажата проверяем правильность нажаития и выводоим картинки правда или ложь
                    ...
                    if(leftnum>50&&rightnum>50&&leftnum<rightnum){
                        img_left_left.setImageResource(R.drawable.truee);
                        img_left_right.setImageResource(R.drawable.truee);}
                    else  if(leftnum<50&&rightnum<50&&leftnum>rightnum){
                        img_left_left.setImageResource(R.drawable.truee);
                        img_left_right.setImageResource(R.drawable.truee);
                    }
                    else if(leftnum<50&&rightnum>50&&(50-leftnum<rightnum-50)){
                        img_left_left.setImageResource(R.drawable.truee);
                        img_left_right.setImageResource(R.drawable.truee);
                    }
                    else if(leftnum>50&&rightnum<50&&(leftnum-50<50-rightnum)){
                        img_left_left.setImageResource(R.drawable.truee);
                        img_left_right.setImageResource(R.drawable.truee);
                    }
