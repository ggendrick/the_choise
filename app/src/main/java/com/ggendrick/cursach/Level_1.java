...
public class Level_1 extends AppCompatActivity {
    ...
    private SharedPreferences pref; //s
    private final String save_key = "save_key";//s
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_change_level = (Button)dialog.findViewById(R.id.button_change_level);
        button_change_level.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {
                    Intent intent = new Intent(Level_1.this,Levels_list.class);
        ...
        butonback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try {   Intent intent = new Intent(Level_1.this,Levels_list.class);
                        startActivity(intent);
                        finish();
                }catch (Exception e){}
            }
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() { //слушатель нажатия на  левую картинку
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) { //метод, вызываемый нажатием на картинку
                if(motionEvent.getAction()==motionEvent.ACTION_DOWN){ // когда картинка нажата проверяем правильность нажаития и выводоим картинки правда или ложь
                    ...
                    if(leftnum>rightnum){ //меняем счет в случае правильного ответа
                        if(score<20){
                            score++;
                        }
                    }
                    ...
                    for(int i = 0 ;i<20;i++){ //меняем прогресс уровня в случае неправильного ответа
                    ...
                    if(score==20){//выход из уровня
                        ...
                        rightnum=random.nextInt(10);//рандом от 0 до 10
                        while(leftnum==rightnum){
                            rightnum=random.nextInt(10);
                        }
                        img_right.setImageResource(array.images_level_1[rightnum]);
        ...
        img_right.setOnTouchListener(new View.OnTouchListener() { //слушатель нажатия на  левую картинку
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) { //метод, вызываемый нажатием на картинку
                if(motionEvent.getAction()==motionEvent.ACTION_DOWN){ // когда картинка нажата проверяем правильность нажаития и выводоим картинки правда или ложь
                    ...
                    if(rightnum>leftnum){ //меняем счет в случае правильного ответа
                        if(score<20){
                            score++;
                        }
                    }
